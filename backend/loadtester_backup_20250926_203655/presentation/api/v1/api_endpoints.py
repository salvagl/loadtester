...
from app.domain.entities.test_scenario import AuthConfig, AuthType, LoadTestConfiguration
...
from app.shared.exceptions.domain import InvalidConfigurationError, LoadTestExecutionError
