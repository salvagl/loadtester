...
from app.infrastructure.external.ai_client import MultiProviderAIClient, OpenAPIParserService
from app.infrastructure.external.k6_runner import K6RunnerService, K6ScriptGeneratorService
from app.infrastructure.external.pdf_generator import PDFGeneratorService, ReportGeneratorService
from app.infrastructure.repositories.api_repository import APIRepository
from app.infrastructure.repositories.endpoint_repository import EndpointRepository
from app.infrastructure.repositories.job_repository import JobRepository
from app.infrastructure.repositories.test_execution_repository import TestExecutionRepository
from app.infrastructure.repositories.test_result_repository import TestResultRepository
from app.infrastructure.repositories.test_scenario_repository import TestScenarioRepository
...
from app.infrastructure.external.data_mock_service import MockDataGeneratorService


class Container(containers.DeclarativeContainer):
    """Dependency injection container - Updated with all services."""
    ...
    # Database session factory - corrected
    db_session = providers.Resource(
        providers.Callable(database_manager.provided.get_session)
    )
    ...
    wiring_config = containers.WiringConfiguration(
        modules=[
            "app.presentation.api.v1.endpoints.load_test",
            "app.presentation.api.v1.endpoints.status",
            "app.presentation.api.v1.endpoints.report",
            "app.presentation.api.v1.endpoints.openapi",
        ]
    )