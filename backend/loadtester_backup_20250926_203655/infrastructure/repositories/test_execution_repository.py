...
from app.domain.entities.test_scenario import TestExecution, ExecutionStatus
from app.domain.interfaces.repositories import TestExecutionRepositoryInterface
from app.infrastructure.database.models import TestExecutionModel
