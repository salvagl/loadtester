...
from app.domain.entities.test_scenario import TestResult, ErrorDetail, PerformanceMetric
from app.domain.interfaces.repositories import TestResultRepositoryInterface
from app.infrastructure.database.models import TestResultModel, ErrorDetailModel, PerformanceMetricModel
