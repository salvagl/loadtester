...
from loadtester.domain.interfaces.domain_interfaces import TestScenarioRepositoryInterface
from loadtester.infrastructure.database.database_models import TestScenarioModel
